...
public class ProjectController {
    ...
    public ResponseEntity<ProjectResponseDTO> create(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(projectService.create(requestDTO, authentication));
    }
    ...
    public ResponseEntity<ProjectResponseDTO> update(
            ...
            Authentication authentication) {
        return ResponseEntity.ok(projectService.update(projectId, requestDTO, authentication));
    }
    ...
    public ResponseEntity<List<ProjectResponseDTO>> getAllProjects(
            ...
            Authentication authentication) {
        return ResponseEntity.ok(projectService.getAllProjects(candidateId, authentication));
    }
    ...
    public ResponseEntity<ProjectResponseDTO> getProject(
            ...
            Authentication authentication) {
        return ResponseEntity.ok(projectService.getProject(projectId, authentication));
    }
}